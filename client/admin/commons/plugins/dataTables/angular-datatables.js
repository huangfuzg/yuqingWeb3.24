...
(function(window, document, $, angular) {
    ...
    function dtOptionsBuilder() {
        ...
        var DTOptions = {
            ...
            withLanguage: function(language) {
                if(language){
            		...
            		this.language = {
        	            ...
        	            "sLengthMenu": "_MENU_ 行/页", //显示每页多少条记录
        	            "sEmptyTable": "无数据", //没有记录时显示的文本
        	            "sZeroRecords": "无符合条件的记录", //没有记录时显示的文本
        	            "sInfo": "总记录数 <span class='text-primary pr10'>_TOTAL_</span> 当前显示 <span class='text-primary ph5'>_START_</span>至<span class='text-primary ph5'>_END_</span>",
        	            "sInfoEmpty": "无数据", //没记录时,关于记录数的显示文本
        	            "sSearch": "搜索:", //搜索框前的文本设置
        	            "sInfoFiltered": " - 来自<span class='text-primary'>_MAX_</span>条总记录的过滤",
        	            "oPaginate": {
        	                "sFirst": "首页",
        	                "sLast": "末页",
        	                "sNext": ">",
             ...
             * @returns {DTOptions} the options
             */
            withDOM: function(isT) {
            	
            	if(isT){
            		if(isT == "T"){
                		this.dom = '<"dt-panelmenu clearfix"fTr>t<"dt-panelfooter clearfix"i<"pagelength"l>p>';
                		this.oTableTools = {
                		    "sSwfPath": "assets/vendor/plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf",
                		    "aButtons": [
        					    { 
        					        "sExtends": "copy", 
        					        "sButtonText": "<span class='text-primary fs14 fa fa-copy p4'> 复制</span>" 
        					    }, 
        					    { 
        					        "sExtends": "print", 
        					        "sButtonText": "<span class='text-primary fs14 fa fa-print p4'> 打印</span>" 
        					    }, 
        					    { 
        					        "sExtends": "csv", 
        					        "sButtonText": "<span class='text-primary fs14 fa fa-save p4'> CSV</span>" 
        					    }
           　　　　　　　　   ]
                	    };
                	}else{
            		...
            		this.dom = '<"dt-panelmenu clearfix"fr>t<"dt-panelfooter clearfix"i<"pagelength"l>p>';
            	}
                return this;
            }
        };
    ...
    function dtDefaultOptions() {
        var options = {
            loadingTemplate: '<h3>请稍等,系统正在努力加载中...</h3>',
            bootstrapOptions: {},
